...
import goryachev.fxeditor.internal.SelectionHelper;
	...
	extends Pane
{
	...
	protected void createCurrentLineHighlight(FxPathBuilder pbuilder, Marker mark)
	{
		...
		if(b != null)
		{
			...
			{
				b.addBoxOutline(pbuilder, m.getLeft(), layout.getTotalWidth()); 
			}
		}
	}
	...
	protected FxEditorLayout getEditorLayout()
	{
		if(layout == null)
		{
			layout = new FxEditorLayout(editor, this);
		}
		return layout;
	}
	...
	protected FxEditorLayout recreateLayout(FxEditorLayout prev)
	{
		...
		FxEditorLayout la = new FxEditorLayout(editor, this);
